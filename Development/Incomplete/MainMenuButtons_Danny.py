...
def on_mouse_press(x, y, button, modifiers):
    ...
    if mouse_hover(x, y, button_newgame):
        button_newgame[button_click] = True

    if mouse_hover(x, y, button_continue):
        button_continue[button_click] = True

def mouse_hover(x, y, button):
    if (x > button[button_x] and x < button[button_x] + button[button_y] and
            y > button[button_y] and y < button[button_y] + button[button_h]):
        return True
    else:
        return False
